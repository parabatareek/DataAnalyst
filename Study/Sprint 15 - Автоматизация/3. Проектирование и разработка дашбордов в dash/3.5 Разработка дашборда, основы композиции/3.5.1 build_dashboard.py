# Прочитайте все поля из таблиц agg_games_year_score и agg_games_year_genre_platform;
# Задайте заголовок дашборда 'История игрового рынка';
# Выведите на дашборд его описание, указанное в переменной note.
#
# Подсказка:
# Получите данные из БД командой SELECT *.
