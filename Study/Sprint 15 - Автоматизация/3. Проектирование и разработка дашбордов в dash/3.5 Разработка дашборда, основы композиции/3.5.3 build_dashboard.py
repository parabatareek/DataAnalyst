# Добавьте функцию update_figures и напишите декоратор. В декораторе укажите:
# Для входного параметра dt_selector дату начала и окончания;
# Для входных параметров mode_selector, genre_selector и platform_selector параметр value;
# Для графиков в Output параметр figure.
#
# Подсказка:
# Input — входящим параметрам. Output — графикам.
...
@app.callback(
    [
        Output('launches_by_year', 'figure'),  # напишите код
        Output('launches_by_platform', 'figure'),  # ваш код
        Output('sales_by_year', 'figure'),
        Output('score_scatter', 'figure'),
    ],
    [
        Input('mode_selector', 'value'),  # ваш код
        Input('dt_selector', 'start_date'),  # ваш код
