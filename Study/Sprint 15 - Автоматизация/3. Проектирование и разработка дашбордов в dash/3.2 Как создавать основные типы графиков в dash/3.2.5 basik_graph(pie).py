# Нарисуйте круговую диаграмму (pie chart), показывающую выпуск игр по платформам.
# Результат отсортируйте по убыванию количества выпущенных игр.
# Выведите топ-10 платформ по количеству выпущенных игр.
# Задайте графику id = 'platform_pie'.
#
# Подсказка:
# Методом go.Pie выведите круговую диаграмму.
