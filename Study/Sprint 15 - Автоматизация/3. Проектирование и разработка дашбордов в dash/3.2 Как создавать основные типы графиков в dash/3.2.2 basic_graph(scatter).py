# Нарисуйте график областей с накоплением ('stacked area chart') для продаж игр в разных регионах по годам.
# Задайте такие цвета линий:
# для Северной Америки красный ('red');
# для Европы зелёный ('green');
# для Японии синий ('blue');
# для остальных регионов оранжевый ('orange').
# Укажите stackgroup = 'one', чтобы отобразить области.

# Подсказка:
# Внутри переменной line_styles для каждого региона задайте словарь параметров линии, например: {'color': 'green'}.
