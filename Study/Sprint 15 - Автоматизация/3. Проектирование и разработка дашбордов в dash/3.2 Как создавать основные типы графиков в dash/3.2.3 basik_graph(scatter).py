# Нарисуй scatter-plot игр в зависимости от оценок игроков и критиков.
# Установите цвет маркеров в соответствии со словарем rating_styles.
# Для всплывающих подсказок установите значения из столбца games_raw['text'].
# Колонка games_raw['text'] должна содержать текст в формате столбец 'platform' + ':' + столбец 'name'.
# Установите hovermode = 'closest'. Задайте графику id = 'score_scatter'.
#
# Проверьте себя:
