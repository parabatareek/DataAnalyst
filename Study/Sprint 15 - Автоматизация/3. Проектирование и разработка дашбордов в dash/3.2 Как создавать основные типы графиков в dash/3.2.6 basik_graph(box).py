# Нарисуйте диаграммы размаха (box plot), показывающие разброс продаж игр по жанрам.
# Параметром y укажите значения из столбца 'total'.
# Задайте графику id = 'games_by_genre'.
#
# Подсказка:
# Выведите диаграмму размаха методом go.Box.
# Установите y = current['total'].
