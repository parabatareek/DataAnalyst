# Нарисуйте линейные графики продаж игр в разных регионах по годам. Задайте такие цвета линий:
# Для Северной Америки: цвет красный ('red'), ширина линии — 4;
# Для Европы: цвет зелёный ('green'), ширина линии — 3, стиль — пунктир ('dash');
# Для Японии: цвет синий ('blue'), ширина линии — 2, стиль — точки ('dot');
# Для остальных регионов: цвет оранжевый ('orange'), ширина линии — 1, стиль — пунктир ('dash').
# Задайте графику id = 'sales_by_year'.
#
# Внутри переменной line_styles для каждого региона задайте словарь параметров линии, например, так: {'color': 'green', 'width': 3, 'dash': 'dash'}.
