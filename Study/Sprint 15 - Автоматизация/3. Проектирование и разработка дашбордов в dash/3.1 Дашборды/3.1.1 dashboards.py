# 1.
# Вот дашборд, который рисует значения тригонометрической функции sin(x) в интервале от -10 до 10.
# Добавьте в дашборд график функции cos(x).
# Задайте id = 'trig_func'.
...
app.layout = html.Div(children=[
    ...
    dcc.Graph(
        figure={'data': data,  # ваш код
                'layout': go.Layout(xaxis={'title': 'x'}, yaxis={'title': 'y'})
                },
        id='trig_func'  # ваш код
    ),
