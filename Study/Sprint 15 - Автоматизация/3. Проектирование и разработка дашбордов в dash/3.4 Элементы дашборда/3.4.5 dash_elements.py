# Расположите элементы дашборда следующим образом:
# График launches_by_year должен занимать восемь (eight) колонок лейаута и иметь высоту в 50% ширины дашборда;
# Справа от него должны быть выведены одной колонкой графики sales_by_platform и sales_by_genre.
# Колонка с графиками должна занимать четыре (four) колонки лейаута.
# Каждый из графиков должен иметь высоту в 25% ширины дашборда.
#
# Подсказка:
# Число колонок в лейауте не должно превышать 12. Его задают так: className = 'eight columns'.
# Относительную высоту элементов указывают так: style = {'height': '25vw'}.
            ...
            [
                html.Div(
                    [
                        ...
                        dcc.Graph(
                            style={'height': '50vw'},  # напишите код
                            id='launches_by_year',
                        ),
                    ],
                ...
                html.Div(
                    [
                        ...
                        dcc.Graph(
                            style={'height': '25vw'},  # напишите код
