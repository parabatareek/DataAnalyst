# Нарисуйте столбчатую диаграмму (bar chart), показывающую выпуск игр по жанрам.
# Результат отсортируйте по убыванию количества выпущенных игр.
# Задайте столбец games_grouped['label'], в котором запишите строки вида 'N игр'.
# Примените его для вывода подписей данных (параметр text столбчатой диаграммы).
# Задайте графику id = 'launches_by_genre'.
#
# Методом go.Bar выведите столбчатую диаграмму.
